function [FUNCTION_VALUE, point_index] = unc_MINFUNC_gamma(u, xi0, T_end, Ts, waypoints, gamma)
...
% Here, the last P(i) is forced to be the last simulated point but there's
% no need according to the professor
