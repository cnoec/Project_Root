...
tic
[u_opt,~,debug] = uncons_NLP_opt(@(u)(cost_function_gamma(u,xi0,T_end,Ts_steer,waypoints,n_wp,20)),u_0,unc_optimalset);
unc_time = toc
...
% 
% [cost, point] = cost_function_gamma(u_0, xi0, T_end, Ts_steer, waypoints, n_wp, 5);
% disp('ok')
% 
% %%
% 
